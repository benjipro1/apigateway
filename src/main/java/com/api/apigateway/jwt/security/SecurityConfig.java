...
import static com.api.apigateway.jwt.security.PublicRoutes.*; //importa las rutas publicas de jwt
import static com.api.apigateway.redireccion.gestion.GestionPublicRoutes.*; //importa las rutas publicas de API Gateway
import static com.api.apigateway.redireccion.productos.ProductosPublicRoutes.*; //importa las rutas publicas de API Productos
import static com.api.apigateway.redireccion.clientes.ClientesPublicRoutes.*; //importa las rutas publicas de API Clientes
