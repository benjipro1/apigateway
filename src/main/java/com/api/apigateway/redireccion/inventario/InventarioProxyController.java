package com.api.apigateway.redireccion.inventario;
...
import com.api.apigateway.jwt.service.*;
...
public class InventarioProxyController {
    ...
    public ResponseEntity<?> proxyProductos(HttpServletRequest request,
        ...
        String targetUrl = "http://localhost:8086/api/inventario" + originalPath;
